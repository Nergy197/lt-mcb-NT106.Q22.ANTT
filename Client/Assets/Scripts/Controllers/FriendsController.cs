...
public class FriendsController : MonoBehaviour
{
    ...
    public Button friendsButton; // kéo FRIENDS bottom button vào dây
    ...
    {
        isSubmittingAddFriend = false; // reset n?u popup dóng gi?a ch?ng request
        if (addFriendNameInput != null)
    ...
    private void EnsureTabButtonsClickable()
    {
        ...
        // Ch? d?t th? t? sibling m?t l?n d? tránh d?o render order m?i l?n d?i tab
