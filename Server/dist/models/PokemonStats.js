...
exports.PokemonStatsModel = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const StatBlockSchema = new mongoose_1.Schema({
...
const PokemonStatsSchema = new mongoose_1.Schema({
    pokemon_instance_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'PokemonInstance', required: true, unique: true },
    ivs: { type: StatBlockSchema, required: true },
    evs: { type: StatBlockSchema, required: true }
});
exports.PokemonStatsModel = mongoose_1.default.model('PokemonStats', PokemonStatsSchema);
